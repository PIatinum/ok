module.exports = {
  ...
  subtitle (data) {
    const info = ['Temperature', 'Weather Text', 'Date', 'City', 'Country', 'Region', 'Wind Speed', 'Wind Chill', 'Wind Direction', 'Humidity', 'Pressure', 'Atmosphere Visibility', 'Sunrise Time', 'Sunset Time', 'Feelslike', 'Image URL', 'Current Day', 'Timezone', 'Latitude', 'Longitude', 'Degree Type', 'Timezone', 'Observation Time', 'Observation Point']
  ...
  variableStorage (data, varType) {
    ...
    switch (info) {
      ...
      case 19:
        ...
        break
      case 20:
        dataType = 'Degree Type'
        break
      case 21:
        dataType = 'Timezone'
        break
      case 22:
        dataType = 'Observation Time'
        break
      case 23:
        dataType = 'Observation Point'
        break
    }
...
<div style="float: left; width: 100%; padding-top: 8px;">
  ...
  <select id="info" class="round">
    ...
    <option value="18">Latitude</option>
    <option value="19">Longitude</option>
    <option value="20">Degree Type</option>
    <option value="21">Timezone</option>
    <option value="22">Observation Time</option>
    <option value="23">Observation Point</option>
  </select>
</div><br>
<div>
      ...
      if (err || !response || response.length < 1) {
        ...
        switch (info) { // Never use deprecated results. Current API doesn't support any of them. RIP old module...
          ...
          case 19:
            ...
            break
          case 20:
            result = response[0].location.degreetype
            break
          case 21:
            result = response[0].location.timezone
            break
          case 22:
            result = response[0].current.observationtime
            break
          case 23:
            result = response[0].current.observationpoint
            break
