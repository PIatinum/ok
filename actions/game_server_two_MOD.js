module.exports = {
  name: 'Store Game Server Info 2.0',
  section: 'Plasorex',

  subtitle (data) {
    const info = ['Server Name', 'Map', 'Number Of Players', 'Number Of Bots', 'Max Players', 'Ping', 'Does Server Have Password?', 'Server Player List', 'Connect']
  ...
  <div class="embed">
    ...
    <div class="embedinfo">
      <span class="embed-auth"><u>Mod Information:</u><br>Made by <b>Doctah</b></span><br>
      <span class="embed-desc">This mod has been edited by <b>Doctah#1984<b><br>Version: 69.0.1</span>
    </div>
  </div><br>
...
<div style="float: left; width: 55%; padding-top: 8px;">
  ...
  <select id="info" class="round">
    ...
    <option value="69">Connect</option>
    </select>
    </div>
